...
import { Firestore, collection, doc, setDoc, getDoc, deleteDoc, collectionData, addDoc, CollectionReference } from '@angular/fire/firestore';
...
export class PostService {
  ...
  constructor(private firestore: Firestore) {
    this.postsCollection = collection(firestore, 'posts') as CollectionReference<Post>;
